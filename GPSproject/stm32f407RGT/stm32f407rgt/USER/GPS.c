...
//void gps_frequently_call(){
//	int aa= TM_GPS_Update(&GPS);
//	
//	if(aa==TM_GPS_Result_NewData){
//	
//	tft_prints(0,2,"sta ok");
//	}
//	
//	else if (aa==TM_GPS_Result_OldData){
//	
//	
//	tft_prints(0,2,"sta old");
//	}
//else if (aa==TM_GPS_Result_FirstDataWaiting){
//	
//	
//	tft_prints(0,2,"waiting");
//	}
//}
